...
import '../../bottom_view/address_bottom_view.dart';
                ...
                onTap: (){
                  commonBottomView(context: context,
                      child: AddressBottomView(
                          title: "Country *",
                          myItems: AddressController.to.countriesList,
                ...
                onTap: (){
                  commonBottomView(context: context,
                      child: AddressBottomView(
                          ...
                          myItems: AddressController.to.statesList,
                          selectionCallBack: (CountryState val) {
              ...
              InkWell(
                onTap: (){
                    commonBottomView(context: context,
                        child: AddressBottomView(
                            title: "City *",
                            myItems: AddressController.to.citiesList,
                            selectionCallBack: (CountryState val) {
                              setState(() {
                                selectedCity = val;
                              });
